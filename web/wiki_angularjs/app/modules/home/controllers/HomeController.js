home.controller("homeController", ['$rootScope', '$scope', '$state', '$stateParams', '$location', 'appSettings' ,'$http',
	function($rootScope, $scope, $state, $stateParams, $location, appSettings, $http){
